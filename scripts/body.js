...
module.exports = {
    ...
    ARCHER: [
        { parts: [Game.TOUGH, Game.TOUGH, Game.TOUGH, Game.RANGED_ATTACK, Game.RANGED_ATTACK, Game.MOVE, Game.MOVE] }
    ],
    BUILDER: [
    ...
    MEDIC: [
        { parts: [Game.TOUGH, Game.TOUGH, Game.MOVE, Game.MOVE, Game.HEAL, Game.HEAL, Game.HEAL] }
    ],
    PACKER: [
